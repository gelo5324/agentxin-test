...
//emoji插件
import './emoji';
import iconsConf from './emoji/icons';
  ...
  image: function image () {
    ...
    if (fileInput === null) {
      ...
      fileInput.addEventListener('change', function () {
        ...
        self.quill.insertEmbed(length, 'image', 'https://yk-fe.oss-cn-beijing.aliyuncs.com/admin/base/emoji/amusing.png')
        self.quill.setSelection(length + 1, 'silent')
